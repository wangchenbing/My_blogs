...
<h3 id="_1-校验数字的表达式" tabindex="-1"><a class="header-anchor" href="#_1-校验数字的表达式" aria-hidden="true">#</a> 1.校验数字的表达式</h3>
<details class="custom-container details"><summary>点击查看代码</summary>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>1. 数字：^[0-9]*$
...
<h3 id="_2-校验字符的表达式" tabindex="-1"><a class="header-anchor" href="#_2-校验字符的表达式" aria-hidden="true">#</a> 2.校验字符的表达式</h3>
<details class="custom-container details"><summary>点击查看代码</summary>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>1. 汉字：^[\u4e00-\u9fa5]{0,}$
...
<h3 id="_3-特殊需求表达式" tabindex="-1"><a class="header-anchor" href="#_3-特殊需求表达式" aria-hidden="true">#</a> 3.特殊需求表达式</h3>
<details class="custom-container details"><summary>点击查看代码</summary>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>1. Email地址：^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$
